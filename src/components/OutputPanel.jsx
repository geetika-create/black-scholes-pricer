        ...
        {GREEK_CONFIGS.map(({ key, label, symbol, format, description }) => (
          <div key={key} style={{ ...panel, padding: 16 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 10 }}>
              <span style={{ fontSize: 12, fontFamily: 'monospace', fontWeight: 600, color: '#8B9099' }}>
                {symbol}
              </span>
            ...
            <p style={{ fontSize: 20, fontWeight: 600, color: '#FFFFFF', fontVariantNumeric: 'tabular-nums', margin: 0 }}>
              {format(result[key])}
            </p>
